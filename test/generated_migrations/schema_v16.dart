...
class AppSettings extends Table with TableInfo {
  ...
  late final GeneratedColumn<int> contraceptionStartDate = GeneratedColumn<int>(
  ...
  late final GeneratedColumn<int> breastfeeding = GeneratedColumn<int>(
    'breastfeeding',
    aliasedName,
    true,
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NULL CHECK (breastfeeding IN (0, 1))',
  );
  late final GeneratedColumn<int> breastfeedingSince = GeneratedColumn<int>(
    'breastfeeding_since',
    aliasedName,
    true,
    type: DriftSqlType.int,
  ...
  late final GeneratedColumn<int> pregnancyStatusDate = GeneratedColumn<int>(
  ...
  late final GeneratedColumn<int> pubertyAnsweredOn = GeneratedColumn<int>(
    'puberty_answered_on',
    aliasedName,
    true,
    type: DriftSqlType.int,
...
class AnalysisSessions extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  AnalysisSessions(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  @override
  AnalysisSessions createAlias(String alias) {
    return AnalysisSessions(attachedDatabase, alias);
  }
...
class AnalysisMessages extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  AnalysisMessages(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<int> includeInModel = GeneratedColumn<int>(
    'include_in_model',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 1 CHECK (include_in_model IN (0, 1))',
    defaultValue: const CustomExpression('1'),
  );
  @override
  List<GeneratedColumn> get $columns => [
  ...
  @override
  AnalysisMessages createAlias(String alias) {
    return AnalysisMessages(attachedDatabase, alias);
  }
...
class DatabaseAtV16 extends GeneratedDatabase {
  ...
  late final AnalysisSessions analysisSessions = AnalysisSessions(this);
  late final AnalysisMessages analysisMessages = AnalysisMessages(this);
  @override
